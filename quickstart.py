...
CLIENT_SECRET_FILE = 'client_secret_xxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com.json'
...
def get_credentials():
    ...
    credential_path = os.path.join(credential_dir,
                                   'client_secret_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com.json')
